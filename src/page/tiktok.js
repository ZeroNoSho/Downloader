...
function Tiktok() {
  ...
  const handle = (val) => {
    axios
      .get(`https://backend-v1.vercel.app/tiktok?url=${val}`)
      .then((res) => {
        setFormat(res.data);
      })
      .catch((err) => {
        ...
        <div className="columns">
          <div className="column">
            <div className="pembungkus-title">
              <h1 className="title is-1 text-center">Free Tiktok Downloader Online</h1>
              <h2 className="subtitle text-center">Download Tiktok video in MP3 or MP4 format</h2>
            </div>
        ...
        <div className="columns">
          <div className="column">
            {format === undefined ? null : (
              ...
              >
                <img src={format.cover[0]} alt="images"></img>
              </div>
            )}
          </div>
        </div>
            ...
            <div className="columns columnbox">
              <div className="column box">
                <table className="table center">
                  <thead>
                    <tr>
                      <th className="m-1"> Video & Music</th>
                    </tr>
                  </thead>
                  {format === undefined ? null : (
                    <tbody>
                      <tr className="is-selected">
                        <th className="m-1">Video</th>
                        <td className="m-1 m-2">
                          <a href={format.video}>Download</a>
                        </td>
                      </tr>
                      <tr className="is-selected">
                        <th className="m-1">Music</th>
                        <td className="m-1 m-2">
                          <a href={format.music}>Download</a>
                        </td>
                      </tr>
                    </tbody>
                  )}
